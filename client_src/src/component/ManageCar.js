...
class Register extends React.Component {
    ...
    onDelete=(id)=>{
        ...
        confirm({
            ...
            let UserId=id;
            console.log(id)
            axios.delete(`http://localhost:3000/api/cars/${UserId}`)
                .then(response=>{
    ...
    render() {
        ...
        columns = [
            ...
            {
                title: 'Car Brand', width: 100, dataIndex: 'brand', key: 'brand', fixed: 'left',
              },
            {
              title: 'Car Model', width: 100, dataIndex: 'model', key: 'model', fixed: 'left',
            },
            {
              title: ' Car color ', dataIndex: 'color', key: 'color', width: 100,
            },
            {
              title: ' Car type ', dataIndex: 'carType', key: 'carType', width: 100,
            },
            {
              title: ' Car Registration number ',
               dataIndex: 'regiNo', key: 'regiNo', 
               width: 100,
            },
            {
              title: ' Car revenue licence copy ',
               dataIndex: 'revenue_li_cpy', 
               key: 'revenue_li_cpy', 
               width: 150,
               render: (record1) =><img style={{ width: '100px', height: '80px' }}
               src={require('../images/revenue_Licence_Copy/'+record1)}
               height={ 80 }
               width={200}
               />
            },
            {
              title: ' Car revenue licence expiry date ', dataIndex: 'revenue_li_ex_date', key: 'revenue_li_ex_date', width: 150,
            },
            {
              title: ' Car Insurence copy ', dataIndex: 'ins_cpy', key: 'ins_cpy', width: 150,
              render: (record2) =><img style={{ width: '100px', height: '80px' }}
               src={require('../images/insurence_Copy/'+record2)}
               height={ 80 }
               width={200}
               />
            },
            {
              title: ' Car Insurence expiry date ', dataIndex: 'ins_exp_date', key: 'ins_exp_date', width: 150,
            },
            {
                title: ' Car Photoes ', dataIndex: 'car_photo', key: 'car_photo', width: 150,
                render: (record3) =>{
                    return record3.split(",").map((image, index) => 
                    <ul>
                        <li>
                            <img style={{ width: '100px', height: '80px' }} 
                            src={require('../images/Car_Image/'+image)} 
                            key={index} />
                        </li>
                    </ul>
                    )
            ...
            {
                title: ' Owner nic Id or Company Name ', dataIndex: 'ownerNICId_companyName', key: 'ownerNICId_companyName', width: 150,
            },
            {
                title: ' Delete ',
                key: 'operation',
                ...
                <Layout>
                    ...
                    <Sider width={200} style={{ background: '#fff' }}>
                        ...
                        <SubMenu key="sub4" title={<span><Icon type="notification" />Manage Booking Car</span>}>
                            <Menu.Item key="13">
                            <NavLink href="/Admin/AdminHome/ManageFleetUser">View All Booking</NavLink>
                            </Menu.Item>
                        </SubMenu>
                        </Menu>
                    </Sider>
                    <Layout style={{ padding: '0 24px 24px' }}>
                        ...
                        >
                        <h3>Car Details Own car Owner</h3>
