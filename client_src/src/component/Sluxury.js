...
class Sluxury extends Component{
	constructor(){
		super();
		this.state = {
			car : []
	...
	getCars(){
		axios.get('http://localhost:3000/api/cars?filter={"where":{"carType":"superLuxury"}}')
		.then(response => {
		...
		return(
			<div style={{background:'#f3f3f3'}}>
				<Row className="containerin">
					...
					/>
					<NavBar /><br/>
					<Row style={{background:'#fff'}} center="xs">
