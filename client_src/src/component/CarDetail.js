...
import { Icon ,DatePicker,Select} from 'antd';
...
class CarDetail extends Component {
  ...
  handleSizeChange = (e) => {
	...
	onSubmit(e){
		...
		const newCar = {
			...
			ownerNICId_companyName : this.state.ownerNICId,
  ...
  render() {
	...
	const { carType, value } = this.state;
  return (
	  <div>
	  <h4 style={{ textAlign : 'justify', fontFamily: 'MarkPro Medium', fontSize: '15', textAlign: 'center'}}>Car Details</h4>
		<form onSubmit ={this.onSubmit.bind(this)}>
			...
			<DatePicker size={"large"} placeholder = " Pick Your Car Insurence Exiry Date"
			...
			<FormGroup>
				<input className="form-control" onChange={this.handleChange} value={this.state.ownerNICId} placeholder="Owner Name" type="hidden" name="NIC_Pass_no"/>
			</FormGroup>
